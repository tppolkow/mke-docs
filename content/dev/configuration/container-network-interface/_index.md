...
You can configure other CNI solutions for use with MKE 4k. Note, though, that Mirantis provides only basic [instruction for configuring unmanaged CNIs for use with MKE 4k](unmanaged-cni-providers). For detailed
